...
<div id="column1" style="float:left; margin:0; width:20.5%;">
- input <br />
...
<div id="column2" style="float:left; margin:0;width:20.5%;">
- target <br />
<audio controls="controls">
...
<div id="column3" style="float:left; margin:0;width:20.5%">
- model-1 <br />
<audio controls="controls">
